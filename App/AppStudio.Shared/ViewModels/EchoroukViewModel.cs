...
{
    public class EchoroukViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("EchoroukDetail", item);
                        });
                }
        ...
        {
            return new EchoroukDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("EchoroukList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("EchoroukDetail");
        }
    }
}
