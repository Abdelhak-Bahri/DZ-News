...
{
    public class ElheddafViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ElheddafDetail", item);
                        });
                }
        ...
        {
            return new ElheddafDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ElheddafList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ElheddafDetail");
        }
    }
}
