...
{
    public class LexpressionViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LexpressionDetail", item);
                        });
                }
        ...
        {
            return new LexpressionDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LexpressionList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LexpressionDetail");
        }
    }
}
