...
{
    public class ElwatanViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ElwatanDetail", item);
                        });
                }
        ...
        {
            return new ElwatanDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ElwatanList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ElwatanDetail");
        }
    }
}
