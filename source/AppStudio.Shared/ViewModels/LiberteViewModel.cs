...
{
    public class LiberteViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LiberteDetail", item);
                        });
                }
        ...
        {
            return new LiberteDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LiberteList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LiberteDetail");
        }
    }
}
